...
class IntranetRtcDiagnostic(models.TransientModel):
    ...
    status_json = fields.Text(string="Diagnostic Result", readonly=True)
    ...
    def _runtime_forbidden_refs(self, module_path):
        ...
        ignored_parts = {"tests", "scripts", "README.md", "README_MEDIA_PIPE.md", "VERSION_HISTORY.md", "intranet_rtc_policy.py", "intranet_rtc_diagnostic.py"}
        hits = []
    ...
    def _build_diagnostics(self):
        ...
        diagnostics = {
            ...
            "effective_ice_servers_sent_to_clients": effective_ice_servers,
            ...
            "cdn_references_in_runtime_code": self._runtime_forbidden_refs(module_path),
        ...
        if diagnostics["cdn_references_in_runtime_code"]:
